<div class="ubicacion m-t-10p documento documentoj">
    <div class="ayuda">Formato por Defecto / Journal</p>
    </div>
</div>
<main class="buscar_checar ">
    <nav class="nav-libro m-t-10p">
        <ul class="navmenu">
            <li ><a href="index.php?accion=formato_defecto">Formato libro</a></li>
            <li class="active"><a href="index.php?accion=formato_defecto_jorunal">Formato Journal</a></li>
        </ul>
    </nav>
    <div class="busqueda m-t-20p ">
        ...
        <div class="btn-formato-listado inputSearch m-t-15p">
            <button class="btn-apa-l btn-apa-j" disabled="disabled">Crear formato</button>
        </div>
    </div>
...
<section class="seccion_formateo hidden m-t-15">
    ...
    <div class="btn_generar_formato ">
        <button class="formato_defecto_jorunal">Generar formato</button>
    </div>
