<main class="edi-book hidden">
    <div class="edit_libro">
        ...
        <div class="guardar">
            <button type="submit" class="btn-editar btn">
                Guardar
            </button>
        </div>
...
<main>
    <div class="ubicacion m-t-10p">
        <div class="ayuda">Referencias > Editar Referencia / Libro</p>
        </div>
    </div>

    <nav class="nav-libro m-t-10p">
        <ul class="navmenu">
            <li class="active"><a href="index.php?accion=editar">Editar libro</a></li>
            <li><a href="index.php?accion=editar-journal">Editar Journal-Conferencia</a></li>
        </ul>
    </nav>
    <div class="busqueda m-t-20p">
        ...
        <div class="extraerCategoria">
            ...
            <div class="active editarlibroB original">
